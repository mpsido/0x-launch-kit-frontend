...
/**
 * This class implements the [web3-provider-engine](https://github.com/ImToken/provider-engine)
 * subprovider interface and the provider sendAsync interface.
 * It handles inconsistencies with ImToken implementations of various JSON RPC methods.
 ...
 */
export class ImTokenSubprovider extends Subprovider {
    private readonly _web3Wrapper: Web3Wrapper;
    private readonly _provider: ZeroExProvider;
    /**
     * Instantiates a new ImTokenSubprovider
    ...
    public async handleRequest(payload: JSONRPCRequestPayload, next: Callback, end: ErrorCallback): Promise<void> {
        ...
        switch (payload.method) {
            ...
            case 'eth_signTypedData_v3':
                [address, message] = payload.params;
                try {
                    // ImToken supports multiple versions and has namespaced signTypedData to v3 for an indeterminate period of time.
                    // eth_signTypedData is mapped to an older implementation before the spec was finalized.
                    // Source: https://github.com/ImToken/ImToken-extension/blob/c49d854b55b3efd34c7fd0414b76f7feaa2eec7c/app/scripts/ImToken-controller.js#L1262
     ...
     * Allowing the ImTokenSubprovider to be used as a generic provider (outside of Web3ProviderEngine) with the
     * addition of wrapping the inconsistent ImToken behaviour
     * @param payload JSON RPC payload
